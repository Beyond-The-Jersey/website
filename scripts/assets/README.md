...
- `assets_process.py` — downloads each URL, renders it to the target size, writes the
  manifest. Resumable: anything already rendered is skipped.
...
python3 scripts/assets/assets_process.py    # rebuild manifest with new hashes
```
